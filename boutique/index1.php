...
// Affichage des produits : 
    ...
    // Ici, je récupère les différentes catégories de la table 'produit' :
...
$content .= '<div class="row">';
    ...
    $content .= "<div class='row'>";
            ...
            if( isset( $_GET['categorie'] ) ){
                ...
                // Ici, je récupère toutes les informations de la table 'produit' à condition QUE  dans la colone categorie, c soitégale à la categorie cliquée
					...
					$content .= "<div class='col-2'>";
						$content .= "<div class='thumbnail' style='border:1px solid #eee'>";
							...
							$content .= "<a href='fiche_produit.php?id_produit=$produit[id_produit]'>";
                                // Ici, je crée un lien <a> pour accéder aux détails du produit et donc accéder au fichier fiche_produit.php et récupérer les infos du produit sur lequel on a cliqué, je fais apsser l'id_produit du produit concerné dans l'url
